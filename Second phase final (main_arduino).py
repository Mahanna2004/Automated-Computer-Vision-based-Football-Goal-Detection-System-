...
# Initialize Serial Communication with Arduino (Change 'COM8' to your port)
...
video_path = "D:\\Goal detection using ML model_all files\\ctrialvidss\\urontomf.MOV"  # Change this to your actual video path
